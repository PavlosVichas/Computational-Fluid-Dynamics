...
%%% plot Psi %%%
figure
contour(0:0.0201:1,0:0.0201:1,flip(Psi),[-0.09:0.01:0.01],'LineWidth', 1 ,'ShowText','on')
title('Reynolds = 1 IMPLICIT')
xlabel('Πλάτος κοιλώματος [m]')
ylabel('Μήκος κοιλωματος [m]')
...
%%% plot Psi %%%
figure
contour(linspace(0,1,Xpoints),linspace(0,1,Xpoints),flip(Psi),[-0.09:0.01:0.01],'LineWidth', 1 ,'ShowText','on')
title('Reynolds = 500 IMPLICIT')
xlabel('Πλάτος κοιλώματος [m]')
ylabel('Μήκος κοιλωματος [m]')
legend('Ροική Συνάρτηση')
