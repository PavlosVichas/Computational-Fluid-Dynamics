%%%%%%%%%%%%% CFD 2ND ASSIGMENT EXPLICIT SCHEME %%%%%%%%%%%%%%%
clear
clc
close all
...
title('Reynolds = 100, Opposite direction <---')
...
%%% plot Psi %%%
figure
contour(0.01:0.01:1,0.01:0.01:1,flip(Psi_new),[0.01:0.01:0.09],'LineWidth', 1 ,'ShowText','on')
title('Reynolds = 100, Opposite direction <---')
xlabel('Πλάτος κοιλώματος [m]')
ylabel('Μήκος κοιλωματος [m]')
